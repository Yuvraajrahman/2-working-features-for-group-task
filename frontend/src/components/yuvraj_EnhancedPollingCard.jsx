...
import { yuvrajIsStudent } from '../services/yuvraj_auth.js';
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-white/10">
          ...
          {isPrivileged && !(yuvrajIsStudent() && typeof window !== 'undefined' && window.location && window.location.pathname && window.location.pathname.includes('/demo')) && (
