            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <EnhancedField label="Priority">
                <select
                  ...
                  className="w-full px-4 py-3 bg-black border border-white/20 rounded-2xl text-white focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400/50 transition-all duration-200"
