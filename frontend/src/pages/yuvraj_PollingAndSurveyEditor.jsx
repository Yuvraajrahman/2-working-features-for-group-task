                            ...
                            {role === 'admin' && (
                              <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => setShowRawResponses((s) => !s)}
                                    className="text-sm px-3 py-1 bg-white/5 rounded-xl text-white/90 hover:bg-white/10"
                                  >
                                ...
                                {showRawResponses ? (
                                  (responses || []).filter((r) => (r.answers && r.answers[qi])).map((r, ri) => (
                                    <div key={ri} className="p-3 bg-white/10 rounded-xl text-sm text-white/90 break-words">
                                      {String((r.answers && r.answers[qi]) || '')}
                                    </div>
                                  ))
                                ) : (
                                  <div className="text-sm text-white/60">{((responses || []).filter((r) => (r.answers && r.answers[qi])).length)} textual responses available</div>
                                )}
